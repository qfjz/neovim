...
vim.keymap.set("n", "<leader>tg", "<cmd>belowright 10split term://$HOME/bin/gi.sh<cr>", { desc = "Uruchamia w terminalu skrypt gi.sh" })
vim.keymap.set("n", "<leader>tp", "<cmd>belowright 10split term://$HOME/bin/pu.sh<cr>", { desc = "Uruchamia w terminal skrypt pu.sh" })
vim.keymap.set("n", "<leader>ta", "<cmd>belowright 10split term://$HOME/bin/ga.sh<cr>", { desc = "Uruchamia w terminal skrypt gp.sh" })
